...
begin
  ...
  begin
    Application.messagebox(PChar('占싱뱄옙 Socket占쏙옙 占쏙옙占쏙옙퓸占?占쌍쏙옙占싹댐옙.'), 'WARNING', MB_OK or MB_ICONINFORMATION);
  end;
end;
...
begin
  ...
  begin
    Application.messagebox(PChar('占싱뱄옙 Socket占쏙옙占쏙옙占쏙옙 占쏙옙占쏙옙占쏙옙 占쌍댐옙 占쏙옙占쏙옙占쌉니댐옙.'), 'WARNING', MB_OK or MB_ICONINFORMATION);
    Exit;
  end
  else
  begin
